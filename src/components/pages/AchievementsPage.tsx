  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white p-6">
      ...
      <div className="bg-slate-900/50 rounded-[3rem] p-8 text-center border border-app-border">
        <span className="material-symbols-rounded text-6xl text-slate-500 mb-6">military_tech</span>
        ...
        <p className="text-slate-500 text-sm font-bold uppercase tracking-[0.2em]">
          Achievements system under development
        </p>
        <p className="text-slate-600 text-xs mt-2">
          Earn badges and stats by playing matches
        </p>
      </div>
    </div>
  );
